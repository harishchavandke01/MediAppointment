...
const DoctorProfile = () => {
  ...
  return profileData &&  (
    <div  className='flex felx-col gap-4 m-5'>
        <div>
          <div>
            <img className='bg-primary/80 w-full sm:max-w-64 rounded-lg' src={profileData.image} alt="" />
          </div>

          <div className='flex-1 border border-stone-100 rounded-lg o-8 py-7 bg-white'>
            ...
            <div className='flex items-center gap-2 mt-1 text-gray-600'>
              ...
              <p className='text-gray-600 font-medium mt-4'>Appointment Fee: <span className='text-gray-800'>{isEdit ? <input type="number" onChange={(e)=>setProfileData(prev => ({...prev, fees:e.target.value}))} value={profileData.fees}/>:profileData.fees}{currency}</span></p>
